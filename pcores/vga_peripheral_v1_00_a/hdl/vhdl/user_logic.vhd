...
-- Date:              Thu Mar 28 10:00:35 2019 (by Create and Import Peripheral Wizard)
...
begin
  ...
  port map(
    clk_i              => clk_i,
    reset_n_i          => reset_n_i,
    --DEO ZA DIRECT MODE. KORISTITI DIR FUNKCIJE
	...
	process (pix_clock_s) begin
		if (rising_edge(pix_clock_s)) then
		  ...
		  char_address <= (others => '0');
			...
			char_value <= "001011" when char_address = "00000000000000" else --k
								"010010" when char_address = "00000000000001" else --r
								"000001" when char_address = "00000000000010"  else --a
								"001010" when char_address = "00000000000011" else --j
								"100000" when char_address = "00000000000100" else --space
								"000011" when char_address = "00000000000101" else --c
								"000001" when char_address = "00000000000110" else --a
								"010011" when char_address = "00000000000111"  else --s
								"000001" when char_address = "00000000001000" else --a
								"000001" when char_address = "00000000101000" else
								"100000";
